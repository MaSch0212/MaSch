...
public partial class SourceBuilder : IStructBuilder
{
    ...
    /// <inheritdoc/>
    IStructBuilder IPropertyDeclarationBuilder<IStructBuilder>.Append(IReadWritePropertyConfiguration propertyConfiguration)
        => Append(propertyConfiguration, null, null);

    /// <inheritdoc/>
    IStructBuilder IPropertyDeclarationBuilder<IStructBuilder>.Append(IReadWritePropertyConfiguration propertyConfiguration, Action<ISourceBuilder> getBuilderFunc, Action<ISourceBuilder> setBuilderFunc)
    ...
    /// <inheritdoc/>
    IStructBuilder IIndexerDeclarationBuilder<IStructBuilder>.Append(IReadWriteIndexerConfiguration indexerConfiguration, Action<ISourceBuilder> getBuilderFunc, Action<ISourceBuilder> setBuilderFunc)
    ...
    /// <inheritdoc/>
    IStructBuilder ISourceBuilder<IStructBuilder>.Append(IRegionConfiguration regionConfiguration, Action<IStructBuilder> builderFunc)
        => Append(regionConfiguration, builderFunc);

    /// <inheritdoc/>
    IStructBuilder ISourceBuilder<IStructBuilder>.Append(ICodeBlockConfiguration codeBlockConfiguration, Action<IStructBuilder> builderFunc)
    ...
    /// <inheritdoc/>
    IStructBuilder ISourceBuilder<IStructBuilder>.EnsureCurrentLineEmpty()
    ...
    /// <inheritdoc/>
    IStructBuilder ISourceBuilder<IStructBuilder>.Indent(Action<IStructBuilder> builderFunc)
        => Indent(builderFunc);
}