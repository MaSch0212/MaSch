...
namespace MaSch.Presentation.Wpf.ThemeValues
{
    public class IconThemeValue : ThemeValueBase<Icon>
    {
        ...
        [JsonIgnore, ThemeValueParsedProperty(nameof(RawIconType))]
        ...
        [JsonIgnore, ThemeValueParsedProperty(nameof(RawCharacter))]
        ...
        [JsonIgnore, ThemeValueParsedProperty(nameof(RawFont))]
        ...
        [JsonIgnore, ThemeValueParsedProperty(nameof(RawFontSize))]
        ...
        [JsonIgnore, ThemeValueParsedProperty(nameof(RawGeometry))]
        ...
        [JsonIgnore, ThemeValueParsedProperty(nameof(RawIsGeometryFilled))]
        ...
        [JsonIgnore, ThemeValueParsedProperty(nameof(RawGeometryStrokeThickness))]
        ...
        [JsonIgnore, ThemeValueParsedProperty(nameof(RawStretch))]
