...
namespace MaSch.Presentation.Wpf.Controls
{
    public class IconButton : Button
    {
        public static readonly DependencyProperty IconProperty =
            DependencyProperty.Register("Icon", typeof(Icon), typeof(IconButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ContentAnchorProperty =
            DependencyProperty.Register("ContentAnchor", typeof(AnchorStyle), typeof(IconButton), new PropertyMetadata(AnchorStyle.None));
