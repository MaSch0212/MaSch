...
namespace MaSch.Presentation.Wpf.Controls
{
    public class IconToggleButton : ToggleButton
    {
        public static readonly DependencyProperty IconProperty =
            DependencyProperty.Register("Icon", typeof(Icon), typeof(IconToggleButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ContentAnchorProperty =
            DependencyProperty.Register("ContentAnchor", typeof(AnchorStyle), typeof(IconToggleButton), new PropertyMetadata(AnchorStyle.None));
