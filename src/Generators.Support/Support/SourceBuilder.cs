...
namespace MaSch.Generators.Support
{
    ...
    /// </summary>
    public partial class SourceBuilder : ISourceBuilder, ISourceFileBuilder
    {
        /// <summary>
...
";
        ...
        private SourceBuilder(int indentSize)
        {
            IndentSize = indentSize;
            _builder = new StringBuilder(AutoGeneratedFileHeader, StartCapacity);
        }
        ...
        public static ISourceFileBuilder Create(int indentSize = 4)
        {
            return new SourceBuilder(indentSize);
        }
