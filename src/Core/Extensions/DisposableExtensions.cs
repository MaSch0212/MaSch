...
namespace MaSch.Common.Extensions
{
    ...
    public static class DisposableExtensions
    {
        ...
        public static void DoAndDispose<TDisposable>(this TDisposable disposable, Action<TDisposable> action) where TDisposable : IDisposable
        {
        ...
        /// <param name="disposable">The <see cref="IDisposable"/> to execute the action on.</param>
        /// <param name="action">The action to execute.</param>
        public static async Task DoAndDisposeAsync<TDisposable>(this TDisposable disposable, Func<TDisposable, Task> action) where TDisposable : IDisposable
        {
            Guard.NotNull(disposable, nameof(disposable));
            using (disposable)
            {
        ...
        public static TResult DoAndDispose<TDisposable, TResult, TOut1>(this TDisposable disposable, Func<TDisposable, (TResult, TOut1)> function, out TOut1 out1) where TDisposable : IDisposable 
        ...
        /// <returns>The first element of the function result.</returns>
        public static TResult DoAndDispose<TDisposable, TResult, TOut1, TOut2>(this TDisposable disposable, Func<TDisposable, (TResult, TOut1, TOut2)> function, out TOut1 out1, out TOut2 out2) where TDisposable : IDisposable 
        ...
        /// <returns>The first element of the function result.</returns>
        public static TResult DoAndDispose<TDisposable, TResult, TOut1, TOut2, TOut3>(this TDisposable disposable, Func<TDisposable, (TResult, TOut1, TOut2, TOut3)> function, out TOut1 out1, out TOut2 out2, out TOut3 out3) where TDisposable : IDisposable
        ...
        /// <returns>The first element of the function result.</returns>
        public static TResult DoAndDispose<TDisposable, TResult, TOut1, TOut2, TOut3, TOut4>(this TDisposable disposable, Func<TDisposable, (TResult, TOut1, TOut2, TOut3, TOut4)> function, out TOut1 out1, out TOut2 out2, out TOut3 out3, out TOut4 out4) where TDisposable : IDisposable
        ...
        /// <returns>The first element of the function result.</returns>
        public static TResult DoAndDispose<TDisposable, TResult, TOut1, TOut2, TOut3, TOut4, TOut5>(this TDisposable disposable, Func<TDisposable, (TResult, TOut1, TOut2, TOut3, TOut4, TOut5)> function, out TOut1 out1, out TOut2 out2, out TOut3 out3, out TOut4 out4, out TOut5 out5) where TDisposable : IDisposable
        ...
        /// <returns>The first element of the function result.</returns>
        public static TResult DoAndDispose<TDisposable, TResult, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>(this TDisposable disposable, Func<TDisposable, (TResult, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6)> function, out TOut1 out1, out TOut2 out2, out TOut3 out3, out TOut4 out4, out TOut5 out5, out TOut6 out6) where TDisposable : IDisposable
        ...
        public static TResult DoAndDispose<TDisposable, TResult>(this TDisposable disposable, Func<TDisposable, TResult> function) where TDisposable : IDisposable
        {
            Guard.NotNull(disposable, nameof(disposable));
            using (disposable)
            {
        ...
        /// <param name="function">The function to execute.</param>
        /// <returns>The result of the function.</returns>
        public static async Task<TResult> DoAndDisposeAsync<TDisposable, TResult>(this TDisposable disposable, Func<TDisposable, Task<TResult>> function) where TDisposable : IDisposable
        {
            Guard.NotNull(disposable, nameof(disposable));
            using (disposable)
            {
