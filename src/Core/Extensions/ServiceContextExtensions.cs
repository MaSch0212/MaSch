...
namespace MaSch.Core
{
    ...
    public static class ServiceContextExtensions
    {
        ...
        {
            return ((IServiceContext)context).GetAllServices();
        }
        ...
        {
            return ((IServiceContext)context).GetAllServices(serviceType);
        }
        ...
        {
            return ((IServiceContext)context).GetService(serviceType, name);
        }
        ...
        {
            return ((IServiceContext)context).ContainsService(serviceType, name);
        }
        ...
        {
            return context.GetAllServices(typeof(T)).Select(x => (x.Name, (T)x.Service));
        }
        ...
        {
            return context.GetService(serviceType, null);
        }
        ...
        {
            return (T)context.GetService(typeof(T), null);
        }
        ...
        {
            return (T)context.GetService(typeof(T), name);
        }
        ...
        {
            return TryGetService(context, out result, null);
        }
        ...
        {
            return context.ContainsService(typeof(T), null) ? (T)context.GetService(typeof(T), null) : default;
        }
        ...
        {
            return context.ContainsService(typeof(T), name) ? (T)context.GetService(typeof(T), name) : default;
        }
        ...
        {
            return context.ContainsService(serviceType, null) ? context.GetService(serviceType, null) : null;
        }
        ...
        {
            return context.ContainsService(serviceType, name) ? context.GetService(serviceType, name) : null;
        }
        ...
        {
            return context.ContainsService(serviceType, null);
        }
        ...
        {
            return context.ContainsService(typeof(T), null);
        }
        ...
        {
            return context.ContainsService(typeof(T), name);
        }
        ...
        {
            return ((IServiceContext<T>)context).GetAllServices();
        }
        ...
        {
            return ((IServiceContext<T>)context).GetService(name);
        }
        ...
        {
            return ((IServiceContext<T>)context).ContainsService(name);
        }
        ...
        {
            return context.ContainsService(null) ? context.GetService(null) : default;
        }
        ...
        {
            return context.ContainsService(name) ? context.GetService(name) : default;
        }
        ...
        {
            return context.ContainsService(null);
        }
