...
namespace MaSch.Test.Components.Test.Assertion
{
    ...
    public class ComparableAssertionsTests
    {
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThan(2, 1));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThan(1, 1));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThan(2, 1, "This is my test"));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThan(1, 1, "This is my test"));
        ...
        public void IsGreaterThan_WithComparer_Fail_Smaller()
        {
            ...
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThan(1, 2, comparer));
        ...
        public void IsGreaterThan_WithComparer_Fail_Equal()
        {
            ...
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThan(1, 1, comparer));
            Assert.AreEqual("Assert.IsGreaterThan failed. Expected:<1>. Actual:<1>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateComparer(2, 1, -1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThan(1, 2, comparer, "This is my test"));
        ...
        {
            using var comparer = CreateComparer(1, 1, 0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThan(1, 1, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsGreaterThan failed. Expected:<1>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThanOrEqualTo(2, 1));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThanOrEqualTo(2, 1, "This is my test"));
        ...
        {
            using var comparer = CreateComparer(2, 1, -1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThanOrEqualTo(1, 2, comparer));
        ...
        {
            using var comparer = CreateComparer(2, 1, -1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsGreaterThanOrEqualTo(1, 2, comparer, "This is my test"));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThan(1, 2));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThan(1, 1));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThan(1, 2, "This is my test"));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThan(1, 1, "This is my test"));
        ...
        {
            using var comparer = CreateComparer(1, 2, 1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThan(2, 1, comparer));
        ...
        {
            using var comparer = CreateComparer(1, 1, 0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThan(1, 1, comparer));
            Assert.AreEqual("Assert.IsSmallerThan failed. Expected:<1>. Actual:<1>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateComparer(1, 2, 1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThan(2, 1, comparer, "This is my test"));
        ...
        {
            using var comparer = CreateComparer(1, 1, 0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThan(1, 1, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsSmallerThan failed. Expected:<1>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThanOrEqualTo(1, 2));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThanOrEqualTo(1, 2, "This is my test"));
        ...
        {
            using var comparer = CreateComparer(1, 2, 1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThanOrEqualTo(2, 1, comparer));
        ...
        {
            using var comparer = CreateComparer(1, 2, 1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsSmallerThanOrEqualTo(2, 1, comparer, "This is my test"));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 1));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 3));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 1, "This is my test"));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, "This is my test"));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 3, "This is my test"));
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, "This is my test"));
        ...
        public void IsBetween_WithComparer_Fail_EqualMin()
        {
            ...
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 1, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<1>.", ex.Message);
        }
        ...
        public void IsBetween_WithComparer_Fail_SmallerMin()
        {
            ...
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>.", ex.Message);
        }
        ...
        public void IsBetween_WithComparer_Fail_EqualMax()
        {
            ...
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 3, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<3>.", ex.Message);
        }
        ...
        public void IsBetween_WithComparer_Fail_GreaterMax()
        {
            ...
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 1, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(3);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 3, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<3>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(4);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, true, false));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 3, true, false));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<3>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, true, false));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, true, false, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 3, true, false, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<3>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, true, false, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, true, false, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(3);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 3, true, false, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<3>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(4);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, true, false, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, true, false, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(3);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 3, true, false, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<3>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(4);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, true, false, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 1, false, true));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<1>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, false, true));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, false, true));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 1, false, true, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, false, true, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, false, true, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 1, false, true, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<1>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, false, true, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(4);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, false, true, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 1, false, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, false, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(4);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, false, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, true, true));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, true, true));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, true, true, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, true, true, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, true, true, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(4);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, true, true, comparer));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(0);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 0, true, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<0>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(4);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsBetween(1, 3, 4, true, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsBetween failed. ExpectedMin:<1>. ExpectedMax:<3>. Actual:<4>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>.", ex.Message);
        }

        [TestMethod]
        public void IsNotBetween_FailWithMessage()
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(2);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, comparer));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(2);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, true, false));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 1, true, false));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<1>.", ex.Message);
        }

        [TestMethod]
        public void IsNotBetween_IncludeMin_FailWithMessage_GreaterMin()
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, true, false, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 1, true, false, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(2);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, true, false, comparer));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 1, true, false, comparer));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<1>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(2);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, true, false, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 1, true, false, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, false, true));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 3, false, true));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<3>.", ex.Message);
        }

        [TestMethod]
        public void IsNotBetween_IncludeMax_FailWithMessage_SmallerMax()
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, false, true, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 3, false, true, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<3>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(2);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, false, true, comparer));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(3);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 3, false, true, comparer));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<3>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(2);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, false, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(3);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 3, false, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<3>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, true, true));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 1, true, true));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<1>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 3, true, true));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<3>.", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, true, true, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 1, true, true, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 3, true, true, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<3>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(2);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, true, true, comparer));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 1, true, true, comparer));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<1>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(3);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 3, true, true, comparer));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<3>.", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(2);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 2, true, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<2>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(1);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 1, true, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<1>. This is my test", ex.Message);
        }
        ...
        {
            using var comparer = CreateBetweenComparer(3);
            var ex = Assert.ThrowsException<AssertFailedException>(() => AssertUnderTest.IsNotBetween(1, 3, 3, true, true, comparer, "This is my test"));
            Assert.AreEqual("Assert.IsNotBetween failed. NotExpectedMin:<1>. NotExpectedMax:<3>. Actual:<3>. This is my test", ex.Message);
        }
